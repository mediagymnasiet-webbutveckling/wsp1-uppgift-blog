...
const {getPosts, createPost, getPost, editFormPost, updatePost, deletePost} = require("./../controllers/postController");
...
router.get("/", getPosts);
 ...
 router.get("/new", function(request, response) {
     response.send("Visa formulär för att skapa ett nytt inlägg");
 });
